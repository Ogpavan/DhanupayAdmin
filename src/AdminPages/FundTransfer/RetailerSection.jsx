...
const RetailerSection = () => {
  ...
  // Fetch wallet balances when retailer is selected
  const fetchWalletBalances = async (retailerId) => {
...
//   }, [walletBalances]);
  ...
  const handleTransfer = async () => {
    // console.log(selectedRetailer, selectedWallet, amount);
                      ...
                      {users
                        ...
                        .map((user) => (
                          <li
                            ...
                            onClick={() => {
                              setSelectedRetailer(user.NewUserID);
                              setSelectedUser(user);
                              setShowDropdown(false);
                            }}
                          >
                            <span className="font-medium">{user.NewUserID}</span> -{" "}
