    ...
    <div className=" overflow-y-scroll">
      <div className="flex justify-between items-center p-4">
        ...
        <button
          ...
          onClick={() => navigate("/user/UserRegistration")}
        >
          Create New User
        </button>
      </div>
              ...
              <tr key={user.NewUserID}>
                ...
                <td className="px-4 py-2 border">
                  <button
                    ...
                    className={`px-4 py-1 rounded-full text-sm font-semibold text-white ${user.KycStatus === "Approved"
                        ? "bg-green-600"
                        : "bg-yellow-600"
                      }`}
                  >
                ...
                <td
                  className={`px-4 py-2 border ${user.EsignStatus?.toLowerCase() === "verified"
                      ? "text-green-600"
                      : "text-yellow-600"
                    }`}
                >
                ...
                <td
                  className={`px-4 py-2 border ${user.LoginStatus.toLowerCase() === "active"
                      ? "text-green-600"
                      : "text-red-600"
                    }`}
                >
